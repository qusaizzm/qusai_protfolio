...
const Portfolio = () => {
  const soloProjects = [
...

    {
      ...
      img: IMG2,
      description:
        "A GPT-3 Website is a text text text text texttext text text text text texttext text text text texttext text.",
    ...
    },
    {
      ...
      img: IMG3,
      description:
        "A Restaurant Website is a text text text text texttext text text text text texttext text text text texttext text.",
      technologies: "Html | CSS | Javascript | Vite / React Js",
      link: "https://qusaizzm.github.io/restaurant_ui/",
      github: "https://github.com/qusaizzm/restaurant_ui",
    },
    {
      id: 4,
      ...
      img: IMG4,
      description:
        "A Portfolio Website is a text text text text texttext text text text text texttext text text text texttext text.",
      technologies: "Html | CSS | Javascript | Next / React Js",
      link: "https://qusaizzm.github.io/protfolio_ui_next.js/",
      github: "https://github.com/qusaizzm/protfolio_ui_next.js",
    },{
      id: 5,
      title: "Hoo payment Website",
      img: IMG5,
      description:
